...
from python.framework.exceptions.collector_exceptions import ConfigurationError
...
class AppConfig:
    ...
    kraken: KrakenCollectorConfig = field(default_factory=KrakenCollectorConfig)
...
class ConfigLoader:
    ...
    def _parse_paths(self, data: Dict[str, Any]) -> PathsConfig:
        ...
        return PathsConfig(
            ...
            processed_data_dir=data.get("processed_data_dir", "./data/processed"),
            broker_configs_dir=data.get("broker_configs_dir", "./configs/brokers"),
    ...
    def _parse_kraken(self, data: Dict[str, Any]) -> KrakenCollectorConfig:
        ...
        return KrakenCollectorConfig(
            ...
            reconnect_max_delay_seconds=data.get("reconnect_max_delay_seconds", 60),
            reconnect_initial_delay_seconds=data.get("reconnect_initial_delay_seconds", 1),
    ...
    def _parse_scheduler(self, data: Dict[str, Any]) -> SchedulerConfig:
        ...
        return SchedulerConfig(
            parquet_conversion_enabled=data.get("parquet_conversion_enabled", True),
